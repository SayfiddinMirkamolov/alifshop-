  ...
  return (
    <header className="container mx-auto px-10 py-4">
      <div className="flex justify-between gap-2 items-center">
        ...
        <Link
          href="/cart"
          className="hidden md:flex flex-col items-center hover:text-main-color relative"
        >
          <MdOutlineShoppingCart size="24px" className="" />
          {cart.length > 0 && (
        ...
        <Link
          href="/favorites"
          className="hidden lg:flex flex-col items-center hover:text-main-color relative"
        >
          <FaRegHeart size="24px" className="" />
          {favorites.length > 0 && (
            <span className="absolute -top-1 -right-3 bg-red-500 text-white text-xs w-5 h-5 flex items-center justify-center rounded-full">
